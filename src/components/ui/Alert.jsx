const Alert = ({ 
  ...
  const variants = {
    ...
    warning: {
      bg: 'bg-yellow-50 border-yellow-200 dark:bg-yellow-500/10 dark:border-yellow-500/30',
    ...
    >
      <div className="flex items-start">
        ...
        {onClose && (
          <button
            onClick={onClose}
            className={`ml-3 inline-flex flex-shrink-0 ${config.text} hover:opacity-75 focus:outline-none`}
          >
