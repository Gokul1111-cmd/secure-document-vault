...
import { Shield, Mail, Lock, User, Eye, EyeOff, Check, X, Sun, Moon } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative">
              <Input
                ...
                required
              />
              <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-9 text-slate-400 dark:text-slate-500">
            ...
            {error && <div className="bg-red-50 border-red-200 text-red-600 dark:bg-red-500/10 dark:border-red-500/30 dark:text-red-200 p-3 rounded-lg text-sm text-center">{error}</div>}
          ...
          <div className="mt-6 text-center text-sm">
             <Link to="/login" className="text-blue-600 hover:underline font-medium dark:text-blue-400 dark:hover:text-blue-300">Already have an account? Sign in</Link>
          </div>
        </Card>
      </div>
    </div>
